 ...
 */
class ViewPager2Adepter(private val context: ViewPager2, private val imageList: MutableList<Int> ): RecyclerView.Adapter<ViewPager2Adepter.PagerViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PagerViewHolder {
        val view = LayoutInflater.from(null).inflate( /*context->null로 변경해둠*/
            R.layout.view_pager_shelter_detail,
            parent,
            false
        )
